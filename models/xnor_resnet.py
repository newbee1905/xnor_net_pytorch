...
from components.bin import BinActive, XNORConv2d, XNORSConv2d, TestXNORConv2d

class XNORResNet18(nn.Module):
	def __init__(self, num_classes=10, model=None, quantize=False, bin_conv2d = TestXNORConv2d):
		super().__init__()
		if model is None:
